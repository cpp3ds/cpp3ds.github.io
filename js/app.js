...
$(function(){
	$('path').each(function(){
		...
		$this.attr({
			'data-start': 'stroke-dashoffset:'+strokelength+';',
			'data-200-end': 'stroke-dashoffset:0; fill-opacity:0; stroke-width:'+strokewidth+'; stroke-opacity:1;',
			'data-end': 'fill-opacity:1; stroke-width:0; stroke-opacity:0;'
		});
	});
	var s = skrollr.init();
});